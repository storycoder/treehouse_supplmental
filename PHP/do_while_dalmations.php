...
//The reason the loop stops at 1 when pre-decrementing is due to how it returns back to to the top of the loop only after first... 
...
//Once this comparison in the while statement is confirmed, one is subtracted and $dalamation now = 0 as it makes its ...
//final pass through the do statement. 
